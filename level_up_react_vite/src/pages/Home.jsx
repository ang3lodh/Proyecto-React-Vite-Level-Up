                    ...
                    <div className="row align-items-center gx-0">
                        <div className="col-lg-6">
                            ...
                            <div className="botones-hero">
                                <a href="productos.html" className="btn-catalogo-inicio">Ver Catálogo</a>
                                <a href="nosotros.html" className="btn-nosotros-inicio">Conócenos</a>
                            </div>
                        </div>
                        <div className="col-lg-6">
                ...
                <div className="container-fluid px-0">
                    ...
                    <div className="grid-categorias-inicio">
                        ...
                        <div className="tarjeta-categoria-inicio">
                            ...
                            <a href="productos.html?categoria=consolas" className="btn btn-outline-light">Ver Consolas</a>
                        </div>
                        ...
                        <div className="tarjeta-categoria-inicio">
                            ...
                            <a href="productos.html?categoria=computadores" className="btn btn-outline-light">Ver PCs</a>
                        </div>
                        ...
                        <div className="tarjeta-categoria-inicio">
                            ...
                            <a href="productos.html?categoria=accesorios" className="btn btn-outline-light">Ver Accesorios</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="productos-destacados-inicio">
                <div className="container-fluid px-0">
                    ...
                    <div className="text-center mt-4">
                        <a href="productos.html" className="btn btn-outline-light">Ver Todos los Productos</a>
                    </div>
                </div>
            </section>
