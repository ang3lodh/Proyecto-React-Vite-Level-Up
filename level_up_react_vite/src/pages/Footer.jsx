function Footer() {
  return (
    <footer className="pie-pagina-inicio bg-dark text-light border-top border-secondary">
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            ...
            <ul className="list-unstyled">
              <li><a href="productos.html" className="text-light">Productos</a></li>
              <li><a href="nosotros.html" className="text-light">Nosotros</a></li>
              <li><a href="contacto.html" className="text-light">Contacto</a></li>
            </ul>
          </div>
          <div className="col-md-4">
            <h6>Contacto</h6>
